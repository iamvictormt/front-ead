...
import { Search, Star, Users, ShoppingCart, Loader2, Check, Gift, LogIn, Eye } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                  {filteredCourses.map((course) => {
                    ...
                    return (
                      <div
                        key={course.id}
                        className="bg-card dark:bg-gray-800 rounded-xl shadow-sm dark:shadow-gray-700/20 border border-border dark:border-gray-700 overflow-hidden hover:shadow-lg dark:hover:shadow-gray-700/30 transition-all duration-400 hover:-translate-y-1"
                      >
                        {/* Course thumbnail */}
                        ...
                        <div className="p-6">
                          ...
                          <div className="flex items-center gap-4 mb-6 text-sm text-muted-foreground dark:text-gray-300">
                            <div className="flex items-center gap-1">
                              ...
                              <span className="font-medium text-card-foreground dark:text-white">{course.rating}</span>
                            </div>
                            <div className="flex items-center gap-1">
        ...
        <DialogContent className="sm:max-w-md bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700">
          <DialogHeader>
            ...
            <DialogDescription className="text-gray-600 dark:text-gray-300">
              Para adicionar cursos ao carrinho e realizar compras, você precisa estar logado. Faça login ou crie uma
          ...
          <DialogFooter className="flex gap-2">
            ...
            <Button
              ...
              className="bg-primary hover:bg-primary/90 text-white dark:bg-blue-600 dark:hover:bg-blue-700"
            >
      ...
      <Dialog open={showFreeDialog} onOpenChange={setShowFreeDialog}>
        <DialogContent className="sm:max-w-md bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700">
          <DialogHeader>
            <DialogTitle className="flex items-center gap-2 text-gray-900 dark:text-white">Curso Gratuito</DialogTitle>
            <DialogDescription className="text-gray-600 dark:text-gray-300">
              Este curso é totalmente gratuito! Ao confirmar, você será automaticamente matriculado e redirecionado para
              a sua área de cursos onde poderá começar a estudar imediatamente.
            </DialogDescription>
          </DialogHeader>
          ...
          {selectedFreeCourse && (
            <div className="py-4">
              <div className="flex items-center gap-3 p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                ...
                />
                <div>
                  <h4 className="font-medium text-sm text-gray-900 dark:text-white">{selectedFreeCourse.title}</h4>
                  <p className="text-xs text-muted-foreground dark:text-gray-400">
                    por {selectedFreeCourse.instructor}
                  </p>
                </div>
              </div>
            </div>
