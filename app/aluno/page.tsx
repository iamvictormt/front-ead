                  ...
                  {/* <div className="bg-white rounded-lg shadow-sm p-4 md:p-6">
                    <div className="flex items-center">
                      <div className="p-2 bg-blue-100 rounded-lg">
                        <Album className="w-5 h-5 md:w-6 md:h-6 text-blue-600" />
                      </div>
                    ...
                    <div className="p-6">
                      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                        <div className="flex-1">
                          ...
                          <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-2">{recentCourse.title}</h3>
                          ...
                          <div className="flex items-center space-x-4 mb-4">
                            <div className="flex items-center space-x-2">
                              ...
                              <span className="text-sm font-medium text-gray-700">{recentCourse.instructor}</span>
                            </div>
                          </div>
                        ...
                        <div className="mt-6 lg:mt-0 lg:ml-8 flex-shrink-0">
                          <img
                            ...
                            className="w-full h-48 lg:w-90 lg:h-48 object-cover rounded-lg shadow-md"
                          />
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="p-6">
                      <div className="space-y-4">
                        {courses.slice(0, 3).map((course) => (
                          <div
                            key={course.id}
                            className="group border border-gray-100 rounded-lg p-4 hover:border-blue-200 hover:shadow-md transition-all"
                          >
                        ...
                        {courses.length === 0 && (
                          <div className="text-center py-12">
                            ...
                            <p className="text-gray-400 text-sm mt-1">Comece sua jornada de aprendizado!</p>
                          </div>
                        )}
                      </div>
                    </div>
                      ...
                      <div className="space-y-4">
                        ...
                        {recentActivity.length === 0 && (
                          <div className="text-center py-12">
                            ...
                            <p className="text-gray-400 text-sm mt-1">Suas atividades aparecerão aqui</p>
                          </div>
                        )}
                      </div>
                    </div>
