                ...
                <div className="bg-white rounded-lg shadow-sm p-4 md:p-6 mb-6">
                  <div className="flex flex-col sm:flex-row gap-4">
                    ...
                    <div className="flex gap-2 hidden md:inline">
                      <Button variant="outline" size="sm" onClick={openCart} className="relative bg-transparent py-4">
                        <ShoppingCart className="h-4 w-4" />
                        {items.length > 0 && (
                          <Badge className="absolute -top-2 -right-2 h-5 w-5 rounded-full p-0 flex items-center justify-center text-xs bg-red-500 text-primary-foreground">
                            {items.length}
                          </Badge>
                        )}
                      </Button>
