            ...
            <div className="bg-white dark:bg-gray-800 md:rounded-lg shadow-sm dark:shadow-gray-700/20 p-4 md:p-6">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div className="flex items-center space-x-4">
                  <div>
                    <h1 className="text-xl md:text-2xl font-bold text-gray-900 dark:text-white">Editar Curso</h1>
                    <p className="text-gray-600 dark:text-gray-300 text-sm mt-1">Atualize as informações do curso</p>
                  </div>
                </div>
                <Button
